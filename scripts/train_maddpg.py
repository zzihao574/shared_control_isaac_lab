...
class TrainingOrchestrator:
    ...
    def _setup_runners_and_evaluators(self):
        ...
        # ============ MODIFIED: Pass evaluator to runner for mid-rollout eval ============
        self.runner = RMAPPOTrainingRunner(
            ...
            evaluator=self.evaluator  # NEW: Pass evaluator reference
        )
        # =================================================================================
    ...
    def train(self):
        ...
        save_final_rmappo_networks(
            ...
            max_milestone_triggered=self.runner.max_milestone_triggered
        )
